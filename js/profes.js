const API_URL = 'http://localhost:8009/api/profesores';

document.addEventListener('DOMContentLoaded', () => {
    const form = document.getElementById('docenteForm');
    const table = document.getElementById('docenteTable').getElementsByTagName('tbody')[0];
    ...
    form.addEventListener('submit', (e) => {
        ...
        addStudent({ name,codigo, email, carrera });
    });
    ...
    function loadStudents() {
        fetch(API_URL)
            ...
            .then(students => {
                ...
                students.forEach(profesor => {
                    addStudentToTable(profesor);
                });
            })
    ...
    function addStudentToTable(profesor) {
        ...
        row.innerHTML = `
            ...
            <td>
                <button onclick="editStudent(${student.id}, '${student.name}', '${student.codigo}', '${student.email}', '${student.carrera}')">Editar</button>
